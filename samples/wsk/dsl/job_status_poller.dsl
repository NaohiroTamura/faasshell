asl([task('Submit Job',"wrn:wsk:functions:::function:/whisk.system/utils/echo",
          [result_path('$.guid')]),
     wait('Wait X Seconds',seconds_path('$.wait_time'),[]),
     task('Get Job Status',"wrn:wsk:functions:::function:job",
     ...
     choices('Job Complete?',
             [case('StringEquals'('$.guid.status',"FAILED"),
              ...
              case('StringEquals'('$.guid.status',"SUCCEEDED"),
                   [task('Get Final Job Status',"wrn:wsk:functions:::function:hello",[])])],
